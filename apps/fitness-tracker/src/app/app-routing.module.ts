...
import { canActivateAdmin, canActivateAuthorized } from '@fitness-tracker/shared/utils';
...
const appRoutes: Route[] = [{
  ...
  children: [
    ...
    {
      path: 'create-user',
      loadChildren: () => import('@fitness-tracker/create-user/feature').then(m => m.CreateUserFeatureModule),
      ...canActivateAdmin
    }
  ],
},
